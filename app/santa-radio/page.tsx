    ...
    <>
      ...
      <section id="listen" className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto bg-gray-100 rounded-2xl aspect-video flex items-center justify-center mb-12">
            <div className="text-center">
              <Radio className="w-12 h-12 text-gray-400 mx-auto mb-3" />
              <p className="text-gray-400 text-sm">Live player embed placeholder</p>
              <p className="text-gray-400 text-xs mt-1">Santa Radio stream will be embedded here</p>
            </div>
          </div>
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <div className="px-6 py-3 bg-gray-900 text-white text-sm rounded-lg font-medium">
